...
Ties: ${this.game.round.ties}\n`);
  ...
  displayRoundChoices() {
    console.clear();
    console.log(`${this.human.name} chose: ${this.human.move}`);
    console.log(
      `${this.computer.name} chose: ${this.computer.move}`);
  },
  ...
  displayGameWinner() {
    console.log(`\n${this.game.gameWinner} won ${ROUNDS_TO_WIN} rounds, winning the game`);
